...
#if [ $# -lt 2 ]
#  then
#    nohup java -Xmx1024m -Xms1024m -javaagent:/app/efun/code/agent/skywalking-agent.jar -classpath $CNF_DIR:$LIB_JARS $1 & >> $BASE_DIR/logs/shell.log
#  else
#    nohup java -Xmx1024m -Xms1024m -javaagent:/app/efun/code/agent/skywalking-agent.jar -classpath $CNF_DIR:$LIB_JARS $1 $2 >> $BASE_DIR/logs/shell.log
#fi
